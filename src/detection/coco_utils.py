...
def get_coco_dataset(root, mode):
    """ A simplified version of what was original in coco_utils.py, specifically for the RoboFlow export format """
    t = [ConvertCocoPolysToMask(), T.PILToTensor()]
    transforms = T.Compose(t)

    img_folder = root / mode
